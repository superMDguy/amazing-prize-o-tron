  ...
  describe('Showing Requests List Controller Tests', function () {
    ...
    describe('Instantiate', function () {
      ...
      it('should send a GET request and return all Showing Requests', inject(function (ShowingRequestsService) {
        ...
        expect($scope.vm.showingRequests.length).toEqual(2);
        expect($scope.vm.showingRequests[0]).toEqual(mockShowingRequest);
        expect($scope.vm.showingRequests[1]).toEqual(mockShowingRequest);
